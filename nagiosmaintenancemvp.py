...
def nagios_maintenance_mvp(self, armor_p, armor_r):
    ...
    command = f"echo '{user_input}' > /u01/home/app/nagios/admin/ham_in_test.txt; cat /u01/home/app/nagios/admin/ham_in.txt"
    ...
    # if rest of case
    if ret["exit_code"] == "0":
        sal.update({"01INFO": "NAGIOS CONNECT SERVER"})
